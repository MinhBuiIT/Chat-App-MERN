  ...
  return (
    <Container maxWidth="md" sx={{ height: '100vh', padding: '24px 0' }}>
      ...
      >
        <Paper
          elevation={2}
          sx={{ height: '320px', padding: '20px', borderRadius: '8px', width: { xs: '94%', sm: '420px', md: '63%' } }}
        >
          <Typography sx={{ fontSize: '24px', marginBottom: '10px' }}>Last Message</Typography>
          <Box sx={{ width: '100%' }}>
            <LineChart dataArr={[65, 59, 80, 81, 56, 55, 40]} />
          </Box>
        </Paper>
        <Paper
          elevation={2}
        ...
        >
          <Box
            sx={{ position: 'absolute', top: '54%', left: '50%', transform: 'translate(-50%,-50%)', display: 'flex' }}
          >
            <Person2OutlinedIcon />
          ...
          >
            <DoughnutChart dataArr={[300, 50]} sx={{ with: '100%' }} />
          </Box>
        </Paper>
        <Stack
        ...
        >
          ...
          >
            ...
            >
              <Typography sx={{ fontSize: '20px', color: '#000' }}>20</Typography>
            </Box>
          ...
          >
            ...
            >
              <Typography sx={{ fontSize: '20px', color: '#000' }}>40</Typography>
            </Box>
            <Stack direction={'row'} spacing={2} alignItems={'center'} sx={{ marginTop: '16px' }}>
              <PeopleOutlinedIcon />
          ...
          >
            ...
            >
              <Typography sx={{ fontSize: '20px', color: '#000' }}>160</Typography>
            </Box>
            <Stack direction={'row'} spacing={2} alignItems={'center'} sx={{ marginTop: '16px' }}>
              <MessageOutlined />
